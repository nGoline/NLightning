...
public class ChannelOpeningFlowTests : IDisposable
{
    ...
    [Fact]
    public async Task OpenChannel_WaitForConfirmations_ChannelBecomesOpen()
    {
        // Arrange
        var bitcoin = _lightningRegtestNetworkFixture.Builder!.BitcoinRpcClient!;
        ...
        // TODO: Complete the test by mining blocks and verifying state transitions
        // For now, verify the flow started
